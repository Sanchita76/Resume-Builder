                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="col-span-2">
                            <Input
                                label="Project Title"
                                placeholder="Vision Supervised Radiology Report"
                                type="text"
                                value={project.title || ""}
                                onChange={
                                    ({target})=>
                        ...
                        <div className="col-span-2">
                            ...
                            <textarea 
                                placeholder="Describe how've built it..."
                                className="form-input w-full mt-1"
                                rows={3}
                                value={project.description || ""}
                                onChange={
                                    ({target})=>
                                        updateArrayItem(index,"description",target.value.replace(/\r?\n/g, '\\n'))
                                }
                            />
                        </div>
                    ...
                    <Input 
                        label="Github Link"
                        placeholder="https://github.com/username/project-repository-name.git"
                        type="url"
