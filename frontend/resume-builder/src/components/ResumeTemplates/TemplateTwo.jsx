...
const DEFAULT_THEME=["#E8FDFF","#A1F4FD","#CEFAFE","#00B8DB","#4A5565"];
...
const TemplateTwo=({resumeData, colorPalette, containerWidth})=>{
    ...
    <div
        ...
        style={{
            ...
            width:containerWidth>0?`${baseWidth}px` : "auto",//Keep the origin so scaling...
            height:"auto",
        }}
        >
            ...
            <div className="px-10 pt-10 pb-5">
                <div className="flex items-start gap-5 mb-5">
                    <div
                        className="w-[140px] h-[140px] max-w-[140px] max-h-[140px] rounded-2xl flwx items-center justify-center"
